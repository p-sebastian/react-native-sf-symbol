...
type TSFSymbolRenderingProps = {
    renderingMode?: 'hierarchical' | 'monochrome';
    colors?: TSFSymbolOneColor;
} | {
    renderingMode: 'palette';
    colors: TSFSymbolPaletteColors;
} | {
    renderingMode: 'multicolor';
    colors?: never;
};
export type TSFSymbolWeight = 'black' | 'bold' | 'heavy' | 'light' | 'medium' | 'regular' | 'semibold' | 'thin' | 'ultralight';
...
type TSFSymbolLayerScope = {
    scope?: 'byLayer' | 'wholeSymbol';
};
type TSFSymbolScale = {
    scale?: 'down' | 'up';
} & TSFSymbolLayerScope;
type TSFSymbolDirection = {
    direction?: 'down' | 'up';
} & TSFSymbolLayerScope;
type TSFSymbolRotate = {
...
type TSFSymbolEffectConfiguration = ({
    ...
    type: 'variableColor';
} & TSFSymbolVariableColor) | ({
    type: 'wiggle';
} & TSFSymbolWiggle);
type TSFSymbolDiscreteEffectConfiguration = Extract<TSFSymbolEffectConfiguration, {
    type: 'bounce' | 'breathe' | 'pulse' | 'rotate' | 'variableColor' | 'wiggle';
}>;
export type TSFSymbolEffect = (TSFSymbolDiscreteEffectConfiguration & {
    behavior: 'discrete';
...
export type TSFSymbolTransition = {
    ...
    type: 'replace';
    direction?: TSFSymbolReplaceDirection;
    scope?: TSFSymbolReplaceScope;
    fallback?: never;
} | {
    type: 'magicReplace';
    fallback?: TSFSymbolReplaceDirection;
    scope?: TSFSymbolReplaceScope;
    direction?: never;
};
type TSFSymbolVariableValueProps = {
    variableValue?: never;
    variableValueMode?: never;
} | {
    variableValue: number;
    variableValueMode?: 'automatic' | 'color' | 'draw';
};
type TSFSymbolHostProps = Pick<ViewProps, 'accessibilityHint' | 'accessibilityLabel' | 'accessibilityLanguage' | 'nativeID' | 'testID'>;
export type TSFSymbolProps = (TSFSymbolBaselineNameProps | TSFSymbolNewerNameProps) & TSFSymbolRenderingProps & TSFSymbolVariableValueProps & TSFSymbolHostProps & {
    size: number;
...
export {};
//# sourceMappingURL=sf-symbol.type.d.ts.map