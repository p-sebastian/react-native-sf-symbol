...
export const SFSymbol = (props) => {
    ...
    return (_jsx(ReactNativeSFSymbolNativeView, { ...nativeProps, accessibilityElementsHidden: !accessible, accessibilityHint: accessible ? accessibilityHint : undefined, accessibilityLabel: accessibilityLabel, accessibilityLanguage: accessible ? accessibilityLanguage : undefined, accessibilityRole: accessible ? 'image' : undefined, accessible: accessible, collapsable: false, nativeID: nativeID, pointerEvents: "none", style: { width: size, height: size }, testID: testID }));
};
